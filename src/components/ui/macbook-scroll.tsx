...
export const MacbookScroll = ({
    ...
    return (
        <div
            ref={ref}
            className="min-h-[180vh]  flex flex-col items-center py-0 md:py-10 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50"
        >
            <motion.h2
    ...
    return (
        <div className="relative [perspective:800px]">
            ...
            <motion.div
                ...
                className="h-96 w-[32rem] absolute inset-0 rounded-lg"
            >
