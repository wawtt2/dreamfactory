...
export const TracingBeam = ({
    ...
    const y1 = useSpring(
        useTransform(scrollYProgress, [0, 0.65], [50, svgHeight]),
        {
            stiffness: 500,
            damping: 90,
        }
    ...
    const y2 = useSpring(
        useTransform(scrollYProgress, [0, 0.85], [50, svgHeight - 200]),
        {
            stiffness: 500,
            damping: 90,
        }
            ...
            <div className="absolute -left-4 md:-left-20 top-3">
                ...
                >
                    <motion.div
                        ...
                        className="h-2 w-2  rounded-full border border-blue-500 bg-white"
                    />
                </motion.div>
                <svg
